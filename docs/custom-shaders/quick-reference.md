...
| `u_mode`           | float | 0, 1, 2... | Current visual mode (lerps smoothly) |
| `u_modeWeight0`    | float | 0-1        | Mode 0 viewport weight (instant)     |
| `u_modeWeight1`    | float | 0-1        | Mode 1 viewport weight (instant)     |
| `u_modeWeight2`    | float | 0-1        | Mode 2 viewport weight (instant)     |
...
**Mode Blending:** Use `u_modeWeight0/1/2` to blend between modes, not `u_mode` ranges. Mode weights represent actual viewport presence.
